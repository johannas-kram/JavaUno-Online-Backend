...
public class PlayerControllerStopPartyTest {
    ...
    public void shouldFailRequestStopPartyCausedByInvalidGameUuid() throws Exception {
        ...
        assertThat(player.isStopPartyRequested()).isFalse();
        assertThat(game.getStopPartyRequested()).isEqualTo(0);
        assertFailure(mvcResult, "de.johannaherrmann.javauno.exceptions.IllegalArgumentException", ExceptionMessage.NO_SUCH_GAME.getValue());
    }
    ...
    public void shouldFailRequestStopPartyCausedByInvalidPlayerUuid() throws Exception {
        ...
        assertThat(player.isStopPartyRequested()).isFalse();
        assertThat(game.getStopPartyRequested()).isEqualTo(0);
        assertFailure(mvcResult, "de.johannaherrmann.javauno.exceptions.IllegalArgumentException", ExceptionMessage.NO_SUCH_PLAYER.getValue());
    }
    ...
    public void shouldFailRequestStopPartyCausedByInvalidState() throws Exception {
        ...
        assertThat(player.isStopPartyRequested()).isFalse();
        assertThat(game.getStopPartyRequested()).isEqualTo(0);
        assertFailure(mvcResult, "de.johannaherrmann.javauno.exceptions.IllegalStateException", ExceptionMessage.INVALID_STATE_GAME.getValue());
    }
